...
import { ArrowLeft, AlertTriangle, Clock, ChevronRight, DollarSign, Plus } from "lucide-react";

// Mock data for now
const mockWorkerDisputes = [
  {
    id: "dis-002",
    jobId: "j004",
    jobTitle: "Emergency Plumbing Repair",
    otherPartyName: "Kofi Asante",
    ...
    <WorkerLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-3">
          {mockWorkerDisputes.map((dispute) => (
            <button
              key={dispute.id}
              onClick={() => router.push(`/worker/disputes/${dispute.id}`)}
