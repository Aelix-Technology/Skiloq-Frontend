...
export function EarningsSummary({ earnings }: EarningsSummaryProps) {
  ...
  return (
    <div className="space-y-3">
      <h2 className="text-md font-semibold text-primary">Earnings</h2>
      ...
      <div className="bg-white rounded-card border border-primary-100 p-4">
        ...
        <div className="flex items-end justify-between gap-3 h-24 mb-4">
          <div className="flex-1 flex flex-col items-center gap-1 h-full justify-end">
            ...
            <div
              className="w-full max-w-[48px] bg-accent rounded-t-card transition-all"
          ...
          <div className="flex-1 flex flex-col items-center gap-1 h-full justify-end">
            ...
            <div
              className="w-full max-w-[48px] bg-accent-300 rounded-t-card transition-all"
          ...
          <div className="flex-1 flex flex-col items-center gap-1 h-full justify-end">
            ...
            <div
              className="w-full max-w-[48px] bg-primary rounded-t-card transition-all"
