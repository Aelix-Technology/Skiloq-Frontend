      ...
      <div className="relative max-w-6xl mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <h2 className="text-[34px] md:text-[52px] font-bold leading-tight mb-4">
            Work in your
            <span className="text-[#4F6AF5]"> language</span>
          </h2>

          <p className="text-white/60 max-w-2xl mx-auto text-[15px] leading-7">
            Skiloq is built for Africa’s linguistic diversity. No one is left behind — your language is supported from day one.
          </p>
        </motion.div>
          ...
          {languages.map((lang, i) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(circle at top, ${lang.accent}20, transparent 70%)`,
                }}
              />
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="relative">
                  ...
                  {/* Online dot */}
                  <span
                    className="absolute bottom-0 right-0 w-3 h-3 rounded-full ring-2 ring-[#1A1F36]"
                    style={{ backgroundColor: lang.accent }}
                  />
                </div>

                {/* Name */}
                <p className="mt-3 text-[13px] font-semibold text-white group-hover:text-white">
                  {lang.name}
                </p>
                ...
                {/* Accent line */}
                <div
                  className="mt-3 w-8 h-[2px] rounded-full opacity-60 group-hover:opacity-100 transition"
                  style={{ backgroundColor: lang.accent }}
                />
              </div>
            </motion.div>
        ...
        <motion.p
          ...
          className="mt-14 text-white/40 text-[12px]"
        >
